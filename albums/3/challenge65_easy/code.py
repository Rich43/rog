...
(here the denominations are ordered from most valuable, the hundred-dollar bill, to least valuable, the penny)
'''
...
def currency(n):
    ...
    n *= 100
    num = 0
    lst = [(10000, 'hundred_dollar_bills'), (5000, 'fifty_dollar_bills'),

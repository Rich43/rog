...
def decode_short(num):
    ...
    if trillion_slice == '':
        ...
        trillion_slice = substring(bill_slice, flag, string_num)
    ...
    if bill_slice == '':
        ...
        bill_slice = substring(bill_slice, flag, string_num)
    ...
    if mill_slice == ''or mill_slice == '000':
        ...
        mill_slice = substring(mill_slice, flag, string_num)
    ...
    if thou_slice == '' or thou_slice == '000':
        ...
        thou_slice = substring(thou_slice, flag, string_num)
        thou = tens_slice
        eng = english[0]
    ...
    if hundred_slice == '' or hundred_slice == '0':
        ...
        hundred_slice = substring(hundred_slice, flag, string_num)
        string_num += hundred_slice
        flag = 1
    return string_num


def substring(n, flag, stringnum):
    ''' str, bool, str
    deal with numbers 1 to 999'''
    strng = ''
